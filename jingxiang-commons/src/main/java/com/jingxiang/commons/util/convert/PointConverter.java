...
public class PointConverter {
     ...
     */
    public com.jingxiang.commons.model.dto.Point from(byte[] bytes) {
        if (bytes == null) {
            return null;
        }
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(bytes)) {
            ...
            // convert to GeoPoint
            com.jingxiang.commons.model.dto.Point geoPoint = new com.jingxiang.commons.model.dto.Point(point.getX(), point.getY());
            return geoPoint;
     ...
     */
    public byte[] to(com.jingxiang.commons.model.dto.Point geoPoint) {
        if (geoPoint == null) {
            return null;
        }
