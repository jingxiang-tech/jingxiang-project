package com.jingxiang.component.user.admin.merchant.config;
 ...
 * @author chenjw
 */
@ConfigurationProperties(prefix = "jingxiang.component.user.admin.merchant")
public class MerchantUserAdminProperties {
