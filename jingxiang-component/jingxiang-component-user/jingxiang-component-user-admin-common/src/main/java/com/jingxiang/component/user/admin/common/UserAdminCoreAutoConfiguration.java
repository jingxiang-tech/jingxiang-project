package com.jingxiang.component.user.admin.common;

import com.jingxiang.component.user.admin.common.service.impl.UserAdminServiceImpl;
import com.jingxiang.component.user.admin.common.service.impl.UserMemberServiceImpl;
import com.jingxiang.component.user.admin.common.service.impl.UserTenantServiceImpl;
...
@MapperScan(
        basePackages = "com.jingxiang.component.user.admin.common.dao",
        sqlSessionFactoryRef = UserDataSourceConfiguration.SQL_SESSION_FACTORY)
public class UserAdminCoreAutoConfiguration {
}
